#ifndef __XPULP_TNN_MATMUL_TERNARY_4X1_H
#define __XPULP_TNN_MATMUL_TERNARY_4X1_H

#include "pulp_nn_utils.h"

uint8_t * __attribute__((noinline)) xpulp_tnn_matmul_ternary_4x1(
                        uint8_t  *pIn,
                        int8_t   *pBias,
                        uint32_t *pThr,
                        uint8_t  *pOut,
...
inline void __attribute__((aligned(4))) hotloop_4x1(
  ...
  {
    *sum = MacLoad20(1, 0, 0, 0, ptrA, *sum);
    ptrA = MacLoadUpdate(ptrA);
    *sum2 = MacLoad20(1, 0, 1, 0, ptrA2, *sum2);
    ptrA2 = MacLoadUpdate(ptrA2);
    *sum3 = MacLoad20(1, 0, 2, 0, ptrA3, *sum3);
    ptrA3 = MacLoadUpdate(ptrA3);
    *sum4 = MacLoad20(1, 0, 3, 0, ptrA4, *sum4);
