...
#define ADDR_FIRST 0x10008000 // avoiding to overwrite the stack
#define ADDR_LAST  0x10010000 // 68kB of L1
#define STRIDE 8
#define NB_CORES 8
...
int main() {
  ...
  uint32_t cnt = 0;
  uint32_t cnt2= 1024; // (ADDR_LAST-ADDR_FIRST)/STRIDE
