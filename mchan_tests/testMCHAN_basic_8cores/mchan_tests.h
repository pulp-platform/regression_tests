...
#define MCHAN_COMMAND_QUEUE    0x50204400 //0x10201800
#define MCHAN_STATUS_REGISTER  0x50204404 //0x10201804

// TEMPORARY FIX DAVIDE
#define PLP_DMA_2D_TCDM_BIT 22

#define PE_MCHAN_COMMAND_QUEUE   0x50201800 //0x10201C00
#define PE_MCHAN_STATUS_REGISTER 0x50201804 //0x10201C04
